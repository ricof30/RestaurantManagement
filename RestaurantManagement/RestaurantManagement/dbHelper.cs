...
namespace RestaurantManagement
{
    ...
    public static class DbHelper
    {
        ...
        {
            return @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Restaurant-main\Restaurant-main\RestaurantManagement\RestaurantManagement\Database.mdf;Integrated Security=True";
        }
