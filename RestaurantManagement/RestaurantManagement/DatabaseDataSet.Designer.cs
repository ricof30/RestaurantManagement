...
namespace RestaurantManagement {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class CategoriesDataTable : global::System.Data.TypedTableBase<CategoriesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CategoriesRow AddCategoriesRow(string category, System.DateTime date) {
...
namespace RestaurantManagement.DatabaseDataSetTableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Categories] WHERE (([Id] = @Original_Id) AND ((@IsNull_categor" +
                "y = 1 AND [category] IS NULL) OR ([category] = @Original_category)) AND ([date] " +
                "= @Original_date))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Categories] ([category], [date]) VALUES (@category, @date);\r\nS" +
                "ELECT Id, category, date FROM Categories WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Categories] SET [category] = @category, [date] = @date WHERE (([Id] = @Original_Id) AND ((@IsNull_category = 1 AND [category] IS NULL) OR ([category] = @Original_category)) AND ([date] = @Original_date));
SELECT Id, category, date FROM Categories WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RestaurantManagement.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, category, date FROM dbo.Categories";
        ...
        public virtual int Delete(int Original_Id, string Original_category, System.DateTime Original_date) {
        ...
        public virtual int Insert(string category, System.DateTime date) {
            if ((category == null)) {
        ...
        public virtual int Update(string category, System.DateTime date, int Original_Id, string Original_category, System.DateTime Original_date, int Id) {
            if ((category == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string category, System.DateTime date, int Original_Id, string Original_category, System.DateTime Original_date) {
            return this.Update(category, date, Original_Id, Original_category, Original_date, Original_Id);
        }
    }
